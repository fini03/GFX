...
All tasks T1, T2, T3(a, b, c, d) and T4 have been fully implemented.

By default the MODE_CAMERA is selected which means the arrow keys will move the camera around.

Note: Every OBJ file has only one color since lighting/shading will be applied in the next assignment.
